...
# Konfigurasi API
API_URL = "https://api.anichin.bio/reelshort/episode"
HEADERS = {
    "X-API-Key": "1c92618eeba02a7504b3979472e035516363585b401df814",
...
for item in data_list:
    ...
    print(f"Memproses series dengan ID: {series_id}")
    ...
    for ep_no in range(1, total_episode + 1):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # Tambahkan ke episode_data - ambil videoUrl default (1080p)
                ep_key = f"s{ep_no}"
                ep_data[ep_key] = result.get("videoUrl", "")
            else:
